...
<div class="container d-flex flex-wrap justify-content-around">    
    <div class="card" style="width: 400px">
        <div class="card-body text-center d-flex flex-column">
            <h5 class="card-title text-uppercase">Abandon</h5>
            <b>Vous avez quitté la partie...</b>
            ...
            <form style="margin-bottom: 20px" name="reviewForm" method="POST" action="index.php?action=play&quit=<?= $idGamestate ?>" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <a class="linkGM" style="margin-bottom: 20px" href="" onclick="document.forms[0].submit(); return false;" title="Noter le jeu" alt="Noter le jeu">Noter</a>              
                </fieldset>
            </form>
        </div>
    </div>
